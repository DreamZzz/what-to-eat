...
- 数据库：PostgreSQL
- 可选依赖：OSS、SMTP、阿里云语音、OpenAI-compatible LLM、可选 Elasticsearch
...
- ES Compose: `ops/elasticsearch/docker-compose.yml`
...
- 菜谱图片是增强能力，不是核心依赖；发布时可先关闭图片生成，保留文本菜谱主流程。
